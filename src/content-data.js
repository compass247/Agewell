...
export const AGEWELL_CONTENT = {
  vi: {
    ...
    form: {
      ...
      serviceOptions: ["Khám bệnh từ xa", "Quản lý bệnh mãn tính", "Rà soát thuốc", "Tôi chưa chắc, cần tư vấn"],
    ...
    footer: {
      ...
      navTitle: "Trang",
      disclaimer: "Disclaimer: Bạn có quyền từ chối hoặc rút khỏi chương trình chăm sóc bất kỳ lúc nào mà không ảnh hưởng đến quyền lợi Medicare Original. Điều kiện tham gia và chi trả phụ thuộc vào gói Medicare Original của từng khách hàng — trong đó dịch vụ Rà Soát Thuốc yêu cầu thêm Medicare Part D. Để biết thêm về quyền lợi Medicare, gọi 1-800-MEDICARE (1-800-633-4227). Compass AgeWell không được CMS hay bất kỳ cơ quan chính phủ nào xác nhận hay bảo trợ.",
